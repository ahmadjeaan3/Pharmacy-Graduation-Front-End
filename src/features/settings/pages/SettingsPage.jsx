    ...
    <label>
      ...
      <div dir={direction} className="relative">
        ...
        <button
          ...
          aria-label={
            visible ? t("إخفاء كلمة المرور") : t("إظهار كلمة المرور")
          }
          title={
            visible ? t("إخفاء كلمة المرور") : t("إظهار كلمة المرور")
          }
...
export function SettingsPage() {
  ...
  const avatarMutation = useMutation({
    ...
    onSuccess: (data) =>
      syncAvatar(data, t("تم تحديث الصورة الشخصية بنجاح.")),

    onError: (error) =>
      setAvatarMessage(getApiErrorMessage(error)),
  });
  ...
  const deleteAvatar = useMutation({
    ...
    onSuccess: (data) =>
      syncAvatar(data, t("تم حذف الصورة الشخصية.")),
  ...
  const submitPassword = (event) => {
    ...
    if (password.newPassword.length < 8) {
      setPasswordMessage(
        t("يجب ألا تقل كلمة المرور الجديدة عن 8 أحرف."),
      );
      ...
      >
        ...
        <section
          className={
            ...
            isAdminAccount ||
            isWarehouseAccount
              ? "relative isolate min-h-[220px] overflow-hidden rounded-[14px] bg-[#10505A] text-white shadow-[0_22px_55px_rgba(23,75,87,.16)] max-sm:min-h-[160px] sm:min-h-[230px] lg:min-h-[250px]"
              : "relative isolate -mt-6 overflow-hidden bg-[#0D7586] text-white max-sm:!w-full max-sm:!mx-0 max-sm:min-h-[160px] sm:-mt-7 lg:-mt-8"
          }
          style={
            isPharmacyAccount ||
            isOrganizationAccount ||
        ...
        >
          ...
          <div
            className={
              ...
              isAdminAccount ||
              isWarehouseAccount
                ? "relative z-10 flex min-h-[220px] w-full items-center px-6 py-7 max-sm:min-h-[160px] max-sm:px-5 max-sm:py-5 sm:min-h-[230px] lg:min-h-[250px] lg:px-9"
                : "relative z-10 mx-auto flex min-h-[220px] w-full max-w-[1240px] items-center px-5 py-9 max-sm:min-h-[160px] max-sm:px-5 max-sm:py-5 sm:px-7 lg:px-8"
            }
          >
            <div
            ...
            >
              <span className="grid size-12 shrink-0 place-items-center rounded-xl bg-white/[.10] text-[#E6F3F6] backdrop-blur-sm max-sm:size-10">
                <Settings
                  size={25}
                  strokeWidth={1.8}
                  className="max-sm:size-[21px]"
                />
              </span>
              ...
              >
                <h1 className="text-[28px] font-bold leading-tight text-white max-sm:text-[22px]">
                  {t("إعدادات الحساب")}
                </h1>

                <p className="mt-3 max-w-[620px] text-[14px] leading-7 text-[#D6D6D6] max-sm:mt-1.5 max-sm:text-[12px] max-sm:leading-5">
                  {t(
                ...
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
                  ...
                  >
                    ...
                    <p className="mt-1 text-[13px] leading-6 text-[#A5A5A5]">
                      {t(
                        "JPG أو PNG أو WebP، بحجم لا يتجاوز 5 ميغابايت.",
                      )}
                    </p>
