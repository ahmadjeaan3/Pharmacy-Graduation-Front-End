...
const DASHBOARD_LOGO_RTL = "/assets/app/brand/dashboard-logo.png";

const DASHBOARD_LOGO_LTR = "/assets/app/brand/dashboard-logo-left.png";
...
export function DashboardLayout() {
  ...
  const dashboardLogo = isArabic ? DASHBOARD_LOGO_RTL : DASHBOARD_LOGO_LTR;
    ...
    >
      ...
      >
        <header className="sticky top-0 z-30 h-[84px] w-full border-b border-[rgba(102,102,102,.16)] bg-white">
          <div className="grid h-full w-full grid-cols-[minmax(0,1fr)_auto] items-center gap-3 px-4 sm:px-6 xl:grid-cols-[minmax(180px,1fr)_minmax(260px,553px)_auto] xl:gap-6 xl:px-10">
            <div
              dir={direction}
