    ...
    <div dir="rtl" className="space-y-5 pb-6">
      ...
      <section className="grid grid-cols-2 gap-3 xl:grid-cols-4">
        ...
        <Stat
          ...
          label="عمليات ناجحة"
          value={
            data.items.filter((item) => item.isSuccess).length
          }
          success
        />
      ...
      <section className="rounded-[1.5rem] border border-[#dce8ea] bg-white p-4 shadow-[0_12px_36px_rgba(23,75,87,.055)] sm:p-5">
        ...
        <div className="grid gap-3 lg:grid-cols-[minmax(240px,1fr)_repeat(4,170px)]">
          ...
          <label className="relative block w-full">
            ...
            <Search
              size={18}
              className="pointer-events-none absolute right-4 top-1/2 z-10 -translate-y-1/2 text-[#6e969e]"
            />

            <input
              type="text"
              className="form-input w-full !pr-12 !pl-4"
...
function LogRow({ item }) {
  return (
    <tr className="align-top transition hover:bg-[#f8fbfb]">
      ...
      <td className="p-4 text-xs text-[#60777d]">
        {item.durationMs} ms
      </td>
