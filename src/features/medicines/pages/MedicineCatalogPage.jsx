  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 -z-20 hidden bg-cover bg-[position:38%_center] bg-no-repeat lg:block"
          style={{
        ...
        <div
          aria-hidden="true"
          className={`absolute -top-24 -z-[4] hidden size-72 rounded-full border-[44px] border-white/[.035] lg:block ${
            isArabic
              ? "-left-12"
              : "-right-12"
          }`}
