...
export function OrganizationDashboardPage() {
  ...
  return (
    ...
    >
      {/* البانر */}
      <section className="relative min-h-[271px] w-full overflow-hidden rounded-xl bg-[#10505a] pb-6 text-white lg:h-[271px] lg:pb-0">
        {/* صورة البانر فقط */}
        <div
          aria-hidden="true"
        ...
        <div
          dir={direction}
          className={`relative z-10 flex w-full flex-col px-5 pb-4 pt-8 sm:px-8 lg:absolute lg:top-[48px] lg:w-[540px] lg:p-0 ${
            isArabic
        ...
        >
          ...
          >
            <Link
              ...
              className={`flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-white px-5 text-sm font-medium text-[#216474] transition hover:bg-[#f8f8f8] sm:w-auto sm:min-w-[180px] sm:px-6 sm:text-base ${
                isArabic ? "flex-row-reverse" : "flex-row"
              }`}
            >
            ...
            <Link
              ...
              className={`flex h-12 w-full items-center justify-center gap-2 rounded-lg border border-white bg-transparent px-5 text-sm font-medium text-white transition hover:bg-white/10 sm:w-auto sm:min-w-[180px] sm:px-6 sm:text-base ${
                isArabic ? "flex-row-reverse" : "flex-row"
              }`}
            >
        ...
        <div
          dir={direction}
          className={`relative z-10 mx-5 flex min-h-[119px] flex-col rounded-xl border border-white/15 bg-white/20 px-[18px] py-5 backdrop-blur-[10px] sm:mx-8 lg:absolute lg:top-[48px] lg:mx-0 lg:h-[119px] lg:w-[249px] ${
            isArabic
