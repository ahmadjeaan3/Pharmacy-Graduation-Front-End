...
export const updateOrganizationCampaign = async (campaignId, payload) =>
  (await apiClient.put(`/organization/me/campaigns/${campaignId}`, payload))
    .data;

export const deleteOrganizationCampaign = async (campaignId) =>
  (await apiClient.delete(`/organization/me/campaigns/${campaignId}`)).data;
